...
#ifndef HACKER_OBJECT_H_
#define HACKER_OBJECT_H_
...
{		
	public:
		...
		virtual void update(std::unordered_map<std::string, Object*> &objectList, std::vector<std::vector<std::vector<Tile*>>> &grid, Uint32 ticks) = 0;
